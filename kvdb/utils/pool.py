...
from typing import Callable, Coroutine, Any, Union, Dict, List, Set, Tuple, TypeVar, Optional, Generator, Awaitable, Iterable, AsyncGenerator
from .helpers import is_coro_func
from .lazy import get_concurrency_limit, set_concurrency_limit
from ..types.proxy import ProxyObject
...
Pooler: ThreadPooler = ProxyObject(
    obj_cls = ThreadPooler,
)